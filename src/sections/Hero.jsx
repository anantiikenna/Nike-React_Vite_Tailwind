  ...
  return (
    <section id="hero" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <span className="xl:bg-white xl:whitespace-nowrap relative z-10 max-lg:z-0 pr-10">The New Arrival</span>
        <br/>
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt20 gap-16">
          {statistics.map((stat) => 
            ( 
              <div key='stat.label'>
